...
// token
abstract class SeoToolCategoryTitleGeneratorTokenService {
  Future<Either<RewildError, String>> getToken();
}

// gigachat
// abstract class SeoToolCategoryTitleGeneratorGigachatService {
...
// balance
abstract class SeoToolCategoryTitleGeneratorBalanceService {
  Future<Either<RewildError, double>> getUserBalance();
  Future<Either<RewildError, bool>> subtractBalance(double amountToSubtract);
}

// price
abstract class SeoToolCategoryTitleGeneratorModelPriceService {
  Future<Either<RewildError, Prices>> getPrice(String token);
}

// // prompt
// abstract class SeoToolCategoryTitleGenertorPromptService {
...
class SeoToolCategoryTitleGeneratorViewModel extends ResourceChangeNotifier
    implements SeoCategoryGeneratorViewModel {
  // final SeoToolCategoryTitleGeneratorGigachatService gigachatService;
  final SeoToolCategoryTitleGeneratorBalanceService balanceService;
  final SeoToolCategoryTitleGeneratorModelPriceService priceService;
  final SeoToolCategoryTitleGeneratorTokenService tokenService;
  // final SeoToolCategoryTitleGenertorPromptService promptService;
