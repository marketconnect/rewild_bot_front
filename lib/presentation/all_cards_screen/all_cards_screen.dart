...
import 'package:rewild_bot_front/presentation/all_cards_screen/widgets/my_sliver_persistent_header_delegate.dart';
import 'package:rewild_bot_front/presentation/all_cards_screen/widgets/product_card_widget.dart';
...
class _AllCardsScreenState extends State<AllCardsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    List<CardOfProduct> productCards = model.productCards;
                    ...
                    onPressed: () {
                      if (emptySubscriptionsQty - len < 0) {
                        Navigator.of(context).pushNamed(
                            "MainNavigationRouteNames.paymentScreen");
                      } else {
                        track();
                      }
                    },
...
CardOfProduct createFakeCardOfProductModel() {
