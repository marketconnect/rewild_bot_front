...
//       {required String token,
//       required List<CardOfProduct> cardOfProductsToPutOnServer});
// }
...
//   List<CardOfProduct> _productCards = [];
//   List<int> get allNmIds => _productCards.map((e) => e.nmId).toList();
//   void setProductCards(List<CardOfProduct> productCards) {
//     _productCards = productCards;
//   }

//   List<CardOfProduct> get productCards => _productCards;
...
//     List<CardOfProduct> oldCards = List.from(_productCards);
...
//     for (CardOfProduct card in fetchedCardsOfProducts) {
...
//   bool filterCard(CardOfProduct card) {
//     if (_filter == null) {
//       return true;
//     }
