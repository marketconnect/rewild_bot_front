...
//       required List<CardOfProduct> cardOfProductsToInsert});
// }
...
//   Either<RewildError, List<CardOfProduct>> _parseCards(String jsonString) {
//     try {
...
//         cards
//             .add(CardOfProduct(nmId: jsonObject['id'], img: jsonObject['img']));
//       }
//       return right(cards);
//     } catch (e) {
